...
## Project Structure
    ...
    ├── testapiautosetting_118351  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_118351`
...
2. Clone this repo and `cd testapiautosetting_118351`
